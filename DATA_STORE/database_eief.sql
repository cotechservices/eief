-- ============================================
-- SCRIPT COMPLET POUR EIFE_PROD
-- Création de toutes les tables et insertion des administrateurs
-- ============================================
...
CREATE TABLE public.classes (
    ...
    FOREIGN KEY (titulaire_id) REFERENCES personnels(id)
);
...
CREATE TABLE public.options_qcm (
    ...
    FOREIGN KEY (question_id) REFERENCES questions_qcm(id) ON DELETE CASCADE
);
...
CREATE TABLE public.reponses_eleves_qcm (
    ...
    FOREIGN KEY (option_id) REFERENCES options_qcm(id)
);
...
CREATE TABLE public.questions_quiz (
    ...
    created_at TIMESTAMP DEFAULT now(),
    created_by INTEGER,
    FOREIGN KEY (categorie_id) REFERENCES categories_quiz(id) ON DELETE CASCADE,
    FOREIGN KEY (enseignement_id) REFERENCES enseignements(id) ON DELETE CASCADE,
...
CREATE TABLE public.reponses_quiz (
    ...
    FOREIGN KEY (participation_id) REFERENCES participations_quiz(id) ON DELETE CASCADE,
    FOREIGN KEY (question_id) REFERENCES questions_quiz(id) ON DELETE CASCADE,
    FOREIGN KEY (option_id) REFERENCES options_quiz(id) ON DELETE CASCADE
);
...
CREATE TABLE public.commandes_fournitures (
    ...
    created_at TIMESTAMP DEFAULT now(),
    FOREIGN KEY (preinscription_id) REFERENCES preinscriptions(id) ON DELETE CASCADE,
    FOREIGN KEY (article_id) REFERENCES articles_librairie(id)
);
...
CREATE TABLE public.preinscription_cantine (
    ...
    created_at TIMESTAMP DEFAULT now(),
    FOREIGN KEY (preinscription_id) REFERENCES preinscriptions(id) ON DELETE CASCADE,
    FOREIGN KEY (menu_id) REFERENCES cantine_menus(id)
);
...
CREATE TABLE public.echeances_paiement (
    ...
    updated_at TIMESTAMP DEFAULT now(),
    FOREIGN KEY (preinscription_id) REFERENCES preinscriptions(id) ON DELETE CASCADE,
    FOREIGN KEY (reinscription_id) REFERENCES reinscriptions(id)
);
...
CREATE TABLE public.paiements (
    ...
    reinscription_id INTEGER,
    FOREIGN KEY (eleve_id) REFERENCES eleves(id) ON DELETE CASCADE,
    FOREIGN KEY (saisie_par) REFERENCES utilisateurs(id),
    FOREIGN KEY (preinscription_id) REFERENCES preinscriptions(id),
    FOREIGN KEY (reinscription_id) REFERENCES reinscriptions(id) ON DELETE CASCADE,
...
CREATE TABLE public.avances_salaires (
    ...
    created_at TIMESTAMP DEFAULT now(),
    FOREIGN KEY (personnel_id) REFERENCES personnels(id) ON DELETE CASCADE,
    FOREIGN KEY (accorde_par) REFERENCES utilisateurs(id) ON DELETE SET NULL,
...
CREATE TABLE public.budget_previsionnel (
    ...
    created_at TIMESTAMP DEFAULT now(),
    updated_at TIMESTAMP DEFAULT now(),
    FOREIGN KEY (categorie_code) REFERENCES categories_depenses(code),
...
CREATE TABLE public.commandes_librairie_articles (
    ...
    prix_unitaire INTEGER NOT NULL,
    created_at TIMESTAMP DEFAULT now(),
    FOREIGN KEY (commande_id) REFERENCES commandes_librairie(id) ON DELETE CASCADE,
    FOREIGN KEY (article_id) REFERENCES articles_librairie(id)
);
...
CREATE TABLE public.ventes_librairie (
    ...
    vendu_par INTEGER,
    FOREIGN KEY (article_id) REFERENCES articles_librairie(id) ON DELETE CASCADE,
    FOREIGN KEY (eleve_id) REFERENCES eleves(id),
    FOREIGN KEY (vendu_par) REFERENCES utilisateurs(id)
);
...
-- 2.60 Cantine menus (ancienne version - à garder pour compatibilité)
...
CREATE TABLE public.reservations_cantine (
    ...
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    FOREIGN KEY (eleve_id) REFERENCES eleves(id) ON DELETE CASCADE,
    FOREIGN KEY (menu_id) REFERENCES menus_cantine(id),
...
CREATE TABLE public.emprunts_bibliotheque (
    ...
    FOREIGN KEY (livre_id) REFERENCES livres_bibliotheque(id) ON DELETE CASCADE,
    FOREIGN KEY (eleve_id) REFERENCES eleves(id) ON DELETE CASCADE,
...
SELECT '2026-2027', '2026-10-01', '2027-06-30', true
...
-- 4.4 Services annexes

-- 4.5 Budget prévisionnel
