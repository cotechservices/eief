...
export async function POST(request: NextRequest) {
  try {
    ...
    const fileName = `annonce_${timestamp}_${random}.${extension}`;
    ...
    if (error) {
      console.error("Erreur upload Supabase (annonces):", error);
      return NextResponse.json(
    ...
    console.error("Erreur dans l'upload d'annonce:", error);
    return NextResponse.json(
