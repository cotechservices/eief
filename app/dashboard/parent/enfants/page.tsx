  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-900">Gérez le suivi scolaire de vos enfants</p>
      </div>
      ...
      {/* Liste des enfants */}
      <div className="mt-6">
        <h2 className="text-lg font-semibold text-gray-900 mb-4">Liste détaillée</h2>
                    ...
                    <div className="p-4 space-y-3">
                      {stats && (
                        <>
                          ...
                          <div className="flex justify-between items-center">
                            <span className="text-gray-900 text-sm flex items-center gap-1"><CreditCard className="w-4 h-4" /> Frais payés</span>
