    ...
    try {
      ...
      if (response.ok) {
        ...
        setStats({
          ...
          preinscriptions: preinscriptionsWithSexe,
          inscriptions: data.stats?.inscriptions || [],
          reinscriptions: reinscriptionsWithSexe,
                ...
                {stats.preinscriptions.map((p) => (
                  <tr key={p.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 text-center">
                      {p.sexe === 'M' ? ' Garçon' : p.sexe === 'F' ? ' Fille' : '—'}
                    </td>
              ...
              <tbody className="divide-y divide-gray-100 text-sm">
                {stats.inscriptions?.map((i) => (
                  <tr key={i.eleve_id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 text-center">
                      {i.sexe === 'M' ? ' Garçon' : i.sexe === 'F' ? ' Fille' : '—'}
                    </td>
              ...
              <tbody className="divide-y divide-gray-100 text-sm">
                {stats.reinscriptions.map((r) => (
                  <tr key={r.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 text-center">
                      {r.sexe === 'M' ? '👦 Garçon' : r.sexe === 'F' ? '👧 Fille' : '—'}
                    </td>
