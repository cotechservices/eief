...
import {
  BookOpen, BookMarked, Users, Search, Plus, Trash2, Edit, CheckCircle, Clock, AlertCircle, X
} from "lucide-react";
...
const CATEGORIES = [
  ...
  { id: "histoire", nom: "Histoire & Géographie", color: "bg-amber-100 text-amber-700" },
...
export default function BibliothequeAdminPage() {
  ...
  const [livreData, setLivreData] = useState({
    titre: "", auteur: "", isbn: "", quantite: 1, emplacement: "", categorie: ""
  });
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl shadow-sm overflow-hidden flex flex-col">
        ...
        <div className="p-4 border-b flex justify-between bg-gray-50/50">
          ...
          {activeTab === "livres" ? (
            <button onClick={() => { setEditingLivre(null); setLivreData({ titre: "", auteur: "", isbn: "", quantite: 1, emplacement: "", categorie: "" }); setShowLivreForm(true); }} className="bg-blue-600 text-white px-4 py-2 rounded-lg text-sm flex items-center gap-2 hover:bg-blue-700">
                  ...
                  return (
                    <tr key={l.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 flex gap-2">
                        <button onClick={() => { setEditingLivre(l); setLivreData(l); setShowLivreForm(true); }} className="text-blue-600 p-1 hover:bg-blue-50 rounded">
      ...
      {/* Formulaire Livre amélioré avec catégories et emplacements */}
      {showLivreForm && (
