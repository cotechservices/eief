  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="bg-white rounded-xl p-4"><div className="flex justify-between"><div><p className="text-gray-500">Recettes (mois)</p><p className="text-2xl font-bold text-purple-600">{stats.recettesMois.toLocaleString()} GNF</p></div><CreditCard className="w-8 h-8 text-purple-200" /></div></div>
      </div>
