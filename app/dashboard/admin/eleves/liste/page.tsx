  ...
  const fetchEleves = async () => {
    ...
    try {
      ...
      const dataWithServices = data.map((e: Eleve) => ({
        ...e,
        transport_inscrit: Math.random() > 0.5,
        transport_statut: Math.random() > 0.5 ? 'paye' : 'non_paye',
        cantine_inscrit: Math.random() > 0.5,
        cantine_statut: Math.random() > 0.5 ? 'paye' : 'non_paye',
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-black">Liste des élèves inscrits</h1>
              ...
              <table className="w-full">
                <thead className="bg-gray-50">
                  <tr>
                    ...
                    <th className="px-4 py-3 text-left text-xs font-medium text-gray-900 uppercase">Bibliothèque</th>
